    ...
    private ProblemDetails ProcessException(Exception exception)
    {
        ...
        switch (exception)
        {
            case ValidationException validationException:
                AddExceptionInfoToProblemDetails(problemDetails, validationException);
                problemDetails.Extensions[ErrorsKey] = validationException.Errors
                    .Select(x => new ProblemFieldDto(x.Key, x.Value));
                break;
